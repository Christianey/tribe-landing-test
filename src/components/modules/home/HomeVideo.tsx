...
export const HomeVideo = () => {
  ...
  const src = "https://www.youtube.com/embed/GR1xQxsXLqY?si=F_3YTAMkNJVPPSoe";
  return (
    <>
      <ScrollAnimation variant="slideUp">
        <div className="w-full shadowTB rounded-2xl h-64 sm:h-96 lg:h-[650px] relative before:inset-0 before:absolute before:rounded-2xl before:bg-black before:bg-opacity-20">
          ...
          <div className="bg-black/10 m-0 w-full h-full absolute top-0 rounded-2xl shadow-xl shadow-zinc-200" />
        </div>
        {!!src && (
          <Modal
            isOpen={isOpen}
